...
while ( have_posts() ) :
	...
	<!-- Courses Page Hero -->
	<section class="page-hero page-hero-template">
	...
	<section class="courses-catalog-section section-pad">
		<div class="nova-container">
			...
			if ( ! empty( $gpi_content ) ) :
				?>
				<div class="courses-page-intro entry-content">
					<?php the_content(); ?>
				</div>
			<?php endif; ?>
						...
						<div class="course-card" data-reveal data-reveal-delay="<?php echo esc_attr( $i * 70 ); ?>">
							<div class="course-card-thumb">
								...
								if ( has_post_thumbnail() ) {
									...
									<div class="course-card-fallback-media">
										<span class="fallback-course-icon"><?php gpi_the_icon( 'award', 36 ); ?></span>
									</div>
									<?php
								}
								?>
							...
							<div class="course-card-body">
								<div class="course-card-meta-top">
									...
									<span class="course-hours"><?php gpi_the_icon( 'clock', 14 ); ?> 8 Weeks</span>
								</div>
								...
								<div class="course-card-footer">
									<a href="<?php the_permalink(); ?>" class="btn btn-sm btn-primary">
										<?php esc_html_e( 'View syllabus', 'gp-industry' ); ?><?php gpi_the_icon( 'arrow-right', 14 ); ?>
									</a>
								</div>
							</div>
						</div>
					...
					<div class="course-card" data-reveal>
						<div class="course-card-thumb">
							<div class="course-card-fallback-media bg-gradient-1">
								<span class="fallback-course-icon"><?php gpi_the_icon( 'bolt', 36 ); ?></span>
							</div>
						...
						<div class="course-card-body">
							<div class="course-card-meta-top">
								<span class="rating-stars">★★★★★ <span>4.9</span></span>
								<span class="course-hours"><?php gpi_the_icon( 'clock', 14 ); ?> 10 Weeks</span>
							</div>
							...
							<div class="course-card-footer">
								...
								<a href="#inquire" class="btn btn-sm btn-primary"><?php esc_html_e( 'Learn more', 'gp-industry' ); ?><?php gpi_the_icon( 'arrow-right', 14 ); ?></a>
							</div>
						</div>
					</div>
					...
					<div class="course-card" data-reveal data-reveal-delay="70">
						<div class="course-card-thumb">
							<div class="course-card-fallback-media bg-gradient-2">
								<span class="fallback-course-icon"><?php gpi_the_icon( 'cog', 36 ); ?></span>
							</div>
					...
					<div class="course-card" data-reveal data-reveal-delay="140">
						<div class="course-card-thumb">
							<div class="course-card-fallback-media bg-gradient-3">
								<span class="fallback-course-icon"><?php gpi_the_icon( 'shield', 36 ); ?></span>
							</div>
							<span class="course-level-badge"><?php esc_html_e( 'Certified', 'gp-industry' ); ?></span>
						</div>
						<div class="course-card-body">
							<div class="course-card-meta-top">
								...
								<span class="course-hours"><?php gpi_the_icon( 'clock', 14 ); ?> 6 Weeks</span>
							</div>
